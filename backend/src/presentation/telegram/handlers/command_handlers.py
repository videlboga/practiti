...
class CommandHandlers(BaseHandler):
        ...
        try:
            ...
            if existing_client:
                ...
                welcome_message = (
                    ...
                    f"🧘‍♀️ Вы зарегистрированы в йога-студии CyberKitty Practiti\n\n"
                ...
                # Новый пользователь
                welcome_message = (
                    f"🌟 Добро пожаловать в йога-студию CyberKitty Practiti!\n\n"
                    f"👋 Привет, {first_name or 'друг'}!\n\n"
                    f"🧘‍♀️ Мы рады видеть вас в нашем пространстве гармонии и практики.\n\n"
                    ...
                    f"✨ Принцип CyberKitty: простота превыше всего!"
                )
        ...
        try:
            ...
            if existing_client:
                ...
                help_message = (
                    ...
                    "✨ CyberKitty Practiti - ваш путь к гармонии! 🧘‍♀️"
                )
                ...
                help_message = (
                    ...
                    "✨ CyberKitty Practiti - просто начните! 🌟"
                )
    ...
    async def info_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            info_message = (
                "🧘‍♀️ **CyberKitty Practiti - Йога Студия**\n\n"
                "✨ **Наша миссия:**\n"
                ...
                "💚 Добро пожаловать в мир йоги с CyberKitty!"
            )
